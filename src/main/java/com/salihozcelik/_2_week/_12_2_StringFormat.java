...
// f
    ...
    public static void formatter1() {
        ...
        formatter.format("Merhabalar Adınız: %s, T.C: %d, Fiyat: %f ", "Salih", 123456, 32.11);
    ...
    public static void formatter2() {
        ...
        String formatterString = String.format("Merhabalar Adınız: %s, T.C: %d, Fiyat: %f ", "Salih", 11223344, 44.23);
    ...
    public static void formatter4() {
        ...
        String formatterString2 = String.format("Merhabalar:" + GREEN + "Adınız: %-10s" + RESET + ":" + RED + "T.C: %10d" + RESET + ":" + YELLOW + "Fiyat: %.4f " + RESET + ":", "Salih", 11223344, 44.23);
